...
if (!apiKey) {
    throw new Error("[LLM] missing OPEN_API_KEY environment variable");
}
if (!fireworksApiKey) {
    throw new Error("[LLM] missing FIREWORKS_API_KEY environment variable");
}
if (!replicateApiKey) {
    throw new Error("[LLM] missing REPLICATE_API_KEY environment variable");
}
