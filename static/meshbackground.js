...
function animateBackground() {
    if (STOP_ANIMATION) {
        ...
        console.log("[Mesh Background] Animation stop")
        return;
    }

    // console.log("[Mesh Background] Animating background");
...
function handleGroupResized(entries) {
...
const groupResizeObserver = new ResizeObserver(handleGroupResized);

function groupCallback(mutationsList) {
...
const addedGroupObserver = new MutationObserver(groupCallback);

addedGroupObserver.observe(containerElement, {
    childList: true,
    subtree: false,
});
